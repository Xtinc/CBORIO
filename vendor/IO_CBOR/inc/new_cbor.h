...
namespace CborLite
{
        ...
        InputIterator &pos, InputIterator end, Tag &tag, Type &t, Flags flags = Flag::none)
    {
        ...
        case Minor::length8:
            ...
            len += 4;
            if ((flags & Flag::requireMinimalEncoding) && !t)
        ...
        case Minor::length1:
            ...
            len++;
            if ((flags & Flag::requireMinimalEncoding) && t < 24)
                throw Exception("encoding not minimal");
            return len;
        }
        ...
        InputIterator &pos, InputIterator end, Type &t, Flags flags = Flag::none)
    {
        ...
        auto value = undefined;
        auto len = decodeTagAndValue(pos, end, tag, value, flags);
        if (tag != Major::textString)
            throw Exception("not TextString");
